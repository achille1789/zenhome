...
class AuthenticationService:
    # same payload as Grouped_Methods_First_Pass.py but action "forget" is replaced by "reset" and "deviceId" is added to allow for different authorisation levels
